                    ...
                    <table class="table table-hover align-middle mb-0" id="reportsTable">
                        ...
                        <tbody>
                            @foreach ($reports as $report)
                                <tr class="{{ $report->is_attend == App\Enums\AttendenceType::ABSENT ? 'table-danger' : ($report->to_pay + $report->to_pay_center > 0 ? 'table-warning' : '') }}">
                                    ...
                                    <td>{{ $report->to_pay + $report->to_pay_center ?? 'N/A' }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
