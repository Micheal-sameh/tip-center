...
@section('content')
    <div class="container py-4" style="max-width: 1200px;">
        ...
        <!-- Search Form -->
        <div class="card-body">
            <form method="GET" action="{{ route('reports.student') }}" class="row g-3 mb-4 align-items-center"
                id="searchForm">
                            ...
                            <tbody>
                                @foreach ($reports as $report)
                                    <tr
                                        ...
                                        <td>{{ $report->to_pay + $report->to_pay_center + $report->to_pay_print + $report->to_pay_materials ?? 'N/A' }}
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function filterRows(query) {
                ...
                tableRows.forEach(row => {
                    ...
                    row.style.display = (code.includes(query) || name.includes(query) || phone.includes(
                        query)) ? '' : 'none';
                });
            }
