...
| Tenant Routes
|--------------------------------------------------------------------------
| All routes here are tenant-scoped. Each tenant (educational center) gets
| its own isolated database. The DemoMode middleware blocks write operations
| when the tenant is flagged as the demo tenant.
|
*/
...
Route::middleware([
    ...
    Route::group(['middleware' => ['setlocale']], function () {
        ...
        Route::middleware(['auth', 'check.status'])->group(function () {
            ...
            Route::get('/student-settlements', [ReportController::class, 'studentSettlements'])->name('reports.student-settlements-alt');
        });
